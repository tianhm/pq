...
if __name__ == "__main__":
    ...
    print sys.argv
    if sys.argv == None:
        print 'need account info.'
        sys.exit(0)
    print sys.argv[1]
    accfile = sys.argv[1]
    try:
        acinfo = shelve.open(accfile)
        # ff['BROKER_ID']='6868'
        # ff['INVESTOR_ID']='1000360'
        # ff['PASSWORD']='qiai1301'
        # ff['ADDR_MD']= "tcp://222.68.181.198:41213"
        # ff['ADDR_TRADE']= "tcp://222.68.181.198:41205"
        # ff.close()
        ...
        print 'file not  exist or filename error.'
