...
class KLinesPump(object):
    ...
    def process_data(self, depth_market_data=None, interval=60, save_dir_path=None):
        ...
        # print depth_market_data.InstrumentID
        ...
        if self.last_ts_step != ts_step:
            ...
            if self.last_ts_step in self.k_lines:
                ...
                if save_dir_path is not None:
                    file_name = '_'.join([depth_market_data.InstrumentID, depth_market_data.TradingDay,
                                          interval.__str__()]) + '.json'

                    print file_name, depth_market_data.InstrumentID
...
#
# k_lines_pump.process_data(depth_market_data=the_data, interval=the_number, save_dir_path=the_dir_path)
